    ...
    <div className='w-full h-full flex flex-col items-center justify-center bg-slate-200'>
      ...
      <form action="" className="py-4 px-8 w-6/12 rounded-md shadow-lg bg-white" onSubmit={handleSubmit(handleAdminLogin)}>
        <div className="w-full flex flex-col p-2">
          ...
          <input {...register("email")} type="text" className="focus:border-b-2 focus:border-green-500 border border-stone-100 border-b-2 p-2 border-b-stone-500" placeholder="john doe" />
        </div>
        <div className="w-full flex flex-col p-2">
          <label htmlFor="" className="font-light text-sky-900">Password</label>
          <input {...register("password")} type="password" className="focus:border-b-2 focus:border-green-500 border border-stone-100 border-b-2 p-2 border-b-stone-500" placeholder="password" />
        </div>
